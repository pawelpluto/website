...
<html lang="en">
	...
	<body>
		...
		<div class="login-container col-md-12">
			<aside class="container main-content mt-5 col-md-2 offset-md-1" id="login-box">
				<div class="row mb-3 mx-0">
					<h1 class="h4 block-title mt-3 mb-2 text-center" id="loginHeader">Login</h1>
					<p class="h4 block-title mt-3 mb-2 text-center" id="welcomeMsg">
					</p>
					...
					<div class="mx-md-1 mb-2 mb-md-0 col-md server-info-box my-1" id="loginForm">
		...
		<div class="container mx-0">
			<div class="row social col-md-2 mt-md-5 offset-md-9 d-none d-lg-block">
		...
		<!-- MAXIMIZED -->
		<div class="container main-content mt-1 mt-md-5 col-xl-6 col-md-8 offset-md-3" id="info-maximized" id="info-maximized">
			<div class="row latest-news">
			<i class="material-icons icon" onclick="foldeInfo()">
				remove
			</i>
				<h1 class="h4 block-title mt-3 mb-2 text-center">Server Info</h1>
				<div>
					<hr class="d-none d-sm-block w-25 mx-auto mt-0">
				</div>
